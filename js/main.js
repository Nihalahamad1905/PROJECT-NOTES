...
$(window).load(function(){
  var $post_para = $(".post-para"),
   ...
   setTimeout(function(){$pre_para.shuffleLetters({ "text": "Enter" });$digm.shuffleLetters({ "text": "Read" });$digm.text("digm");},1000);
   setTimeout(function(){$pre_para.shuffleLetters({ "text": "into the" });$digm.shuffleLetters({ "text": "Write" });$digm.text("digm");},2000);
   setTimeout(function(){$pre_para.shuffleLetters({ "text": "new World" });$digm.shuffleLetters({ "text": "Share" });$digm.text("digm");},3000);

   setTimeout(function(){$pre_para.addClass("invisible");$post_para.fadeIn(600); $digm.text("TYCSE");},4000);
});
